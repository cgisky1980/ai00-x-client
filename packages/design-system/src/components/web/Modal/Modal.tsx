/**
 * Modal component —— E3a 接 Radix Dialog 基件：
 * 焦点陷阱 / 焦点回归 / aria-modal / Escape / 滚动锁 由 Radix 提供；
 * 拖拽 / 缩放 / placement / Tauri data-no-penetrate 保留原有自绘逻辑。
 * DOM 结构与 class 不变（Content 嵌套于 Overlay 内，保持 flex 居中与外部
 * overlayClassName 钩子，如 .modal-overlay.music-popup-share-overlay）。
 */
...
export const Modal: React.FC<ModalProps> = ({
  ...
  const portalTarget = container ?? portalContainer ?? document.body;
      ...
      <DialogPrimitive.Portal container={portalTarget}>
        ...
        >
          <DialogPrimitive.Content
            ...
            aria-label={title ? undefined : tLabel('components.modal.dialog', '对话框')}
              ...
              >
                ...
                {showCloseButton && (
                  <button
                    ...
                    onClick={onClose}
                    aria-label={tLabel('components.modal.close', '关闭')}
                    type="button"
                  >
