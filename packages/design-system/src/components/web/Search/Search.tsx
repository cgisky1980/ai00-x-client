...
export const Search = forwardRef<HTMLInputElement, SearchProps>(({
  ...
  const resolvedPlaceholder = placeholder ?? tLabel('components.search.placeholder', '搜索...');
  const resolvedSearchButtonText = searchButtonText ?? tLabel('components.search.placeholder', '搜索...').replace('...', '');
    ...
    <div className={classNames}>
      ...
      >
        ...
        <input
          ...
          onFocus={handleFocus}
          onBlur={handleBlur}
          aria-label={inputAriaLabel ?? tLabel('components.search.placeholder', '搜索...')}
        ...
        {clearable && inputValue && !loading && !disabled && (
          <button
            ...
            onClick={handleClear}
            aria-label={tLabel('components.search.clear', '清除')}
            tabIndex={-1}
          >
        ...
        {showSearchButton && (
          <button
            ...
            aria-label={tLabel('components.search.placeholder', '搜索...')}
          >
