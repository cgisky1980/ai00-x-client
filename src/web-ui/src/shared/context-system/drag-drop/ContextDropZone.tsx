...
export const ContextDropZone: React.FC<ContextDropZoneProps> = ({
  ...
  return (
    <div
      ref={dropZoneRef}
      className={`
        ai00-x-context-drop-zone
        ${isDragOver ? 'ai00-x-context-drop-zone--drag-over' : ''}
        ${canAccept ? 'ai00-x-context-drop-zone--can-accept' : ''}
        ${!canAccept && isDragOver ? 'ai00-x-context-drop-zone--cannot-accept' : ''}
        ${className}
      `.trim()}
