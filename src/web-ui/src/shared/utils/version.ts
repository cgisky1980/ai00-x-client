...
export function getAboutInfo(): AboutInfo {
  ...
  return {
    ...
    license: {
      type: 'MIT',
      text: 'MIT License - Copyright (c) 2025 Ai00-X',
      url: 'https://opensource.org/licenses/MIT'
    },
    links: {
      homepage: 'https://github.com/yourusername/ai00-x',
      repository: 'https://github.com/yourusername/ai00-x',
      documentation: 'https://github.com/yourusername/ai00-x/wiki',
      issues: 'https://github.com/yourusername/ai00-x/issues'
    }
  };
}
