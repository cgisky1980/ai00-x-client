...
function mapWorkspaceWorktree(
  ...
  return {
    ...
    mainRepoName: worktree.mainRepoName ?? undefined,
  };
}
...
function mapWorkspaceInfo(workspace: APIWorkspaceInfo): WorkspaceInfo {
  return {
    ...
    repoRootPath: workspace.repoRootPath ?? undefined,
    activeBranch: workspace.activeBranch ?? undefined,
    availableBranches: (workspace.availableBranches || []).map((b: any) => ({
      name: b.name,
      worktreePath: b.worktreePath,
      isMain: b.isMain,
      isActive: b.isActive,
      hasChanges: b.hasChanges ?? undefined,
    })),
