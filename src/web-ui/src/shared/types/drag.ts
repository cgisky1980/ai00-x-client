...
/**
 * Custom MIME type for transferring Ai00-X context payloads via the browser DnD API.
 */
export const AI00X_CONTEXT_MIME_TYPE = 'application/x-ai00-x-context';
export const AI00X_CONTEXT_JSON_MIME_TYPE = 'application/json';
