...
/** Reserved config value: follow OS light/dark (maps to ai00-x-light / ai00-x-dark). */
...
export interface OverlayColors {
  overlay: ColorValue;
  modalOverlay: ColorValue;
}

export interface CardBackgroundColors {
  default: ColorValue;
  elevated: ColorValue;
  subtle: ColorValue;
  hover: ColorValue;
