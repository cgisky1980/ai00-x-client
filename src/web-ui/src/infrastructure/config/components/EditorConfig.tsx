...
const EditorConfig: React.FC<EditorConfigProps> = () => {
  ...
  if (isLoading) {
    return (
      <ConfigPageLayout className="ai00-x-editor-config">
        <ConfigPageHeader
          title={t('title')}
          subtitle={t('subtitle')}
        />
  ...
  return (
    <ConfigPageLayout className="ai00-x-editor-config">
      ...
      <ConfigPageContent className="ai00-x-editor-config__content">
        <ConfigPageSection
        ...
        >
          <ConfigPageRow label={t('actions.reset')} description={t('messages.confirmReset')} align="center">
            <div className="ai00-x-editor-config__actions">
              <Button
                variant="secondary"
                size="small"
                onClick={resetConfig}
              ...
              {isSaving && (
                <span className="ai00-x-editor-config__saving">{t('messages.saving')}</span>
              )}
            </div>
          </ConfigPageRow>
        </ConfigPageSection>
