...
const LSP_SETTINGS_KEY = 'ai00-x_lsp_settings';
...
const LspConfig: React.FC = () => {
  ...
  return (
    <ConfigPageLayout className="ai00-x-lsp-config">
      <ConfigPageHeader title={t('title')} subtitle={t('subtitle')} />

      <ConfigPageContent>
        {installMessage && (
          <div className="ai00-x-lsp-config__message-container">
        ...
        <ConfigPageSection
          ...
          extra={
            <>
              ...
              >
                <RefreshCw size={16} className={isInitializing ? 'ai00-x-lsp-config__spinning' : ''} />
              </IconButton>
              <IconButton
                variant="ghost"
                size="small"
        ...
        >
          <div className="ai00-x-lsp-config__plugins">
            <LspPluginList
