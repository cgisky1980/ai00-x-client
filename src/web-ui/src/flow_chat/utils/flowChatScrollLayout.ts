...
/** Matches `.ai00-x-chat-input-drop-zone { bottom: … }` */
...
/** Effective height of PlanInputCard visible above ChatInput (min-height 56px - 8px overlap) */
export const PLAN_INPUT_CARD_EFFECTIVE_HEIGHT_PX = 48;
...
export function computeFlowChatInputStackFooterPx(
  ...
  return inputBlock + CHAT_INPUT_DROP_ZONE_BOTTOM_PX + FLOWCHAT_MESSAGE_TAIL_CLEARANCE_PX
    + PLAN_INPUT_CARD_EFFECTIVE_HEIGHT_PX;
}
