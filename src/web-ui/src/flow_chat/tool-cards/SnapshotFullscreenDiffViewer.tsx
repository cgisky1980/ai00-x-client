...
import type { SnapshotFile } from '../../tools/snapshot-system/core/SnapshotStateManager';
...
export const SnapshotFullscreenDiffViewer: React.FC<SnapshotFullscreenDiffViewerProps> = ({
  ...
  const fullscreenContent = (
    <div className="snapshot-fullscreen-overlay" data-no-penetrate onClick={handleBackdropClick}>
