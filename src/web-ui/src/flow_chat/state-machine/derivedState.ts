...
function getProgressBarMode(phase: ProcessingPhase | null): SessionDerivedState['progressBarMode'] {
  switch (phase) {
    ...
    case ProcessingPhase.WORKFLOW_PLANNING:
      return 'indeterminate';

    case ProcessingPhase.AWAITING_PLAN_CONFIRMATION:
      return 'segmented';

    case ProcessingPhase.WORKFLOW_EXECUTING:
      return 'segmented';

    case ProcessingPhase.WORKFLOW_REVIEWING:
      return 'indeterminate';
