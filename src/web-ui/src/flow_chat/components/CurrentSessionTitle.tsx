...
const CurrentSessionTitle: React.FC<CurrentSessionTitleProps> = ({ onCreateSession }) => {
  ...
  return (
    <div className="ai00-x-current-session-title">
      <span className="ai00-x-current-session-title__text">{title}</span>
      <Tooltip content={newSessionLabel} placement="bottom">
        <button
          className="ai00-x-current-session-title__create-btn"
