...
export const SmartRecommendations: React.FC<SmartRecommendationsProps> = ({
  ...
  return (
    <div className={`ai00-x-smart-recommendations ${className}`}>
      <div className="ai00-x-smart-recommendations__header">
        <span className="ai00-x-smart-recommendations__title">{t('smartRecommendations.title')}</span>
        <Tooltip content={t('smartRecommendations.close')}>
          <button
            className="ai00-x-smart-recommendations__close"
            onClick={handleClose}
          >
            <X size={16} />
          </button>
