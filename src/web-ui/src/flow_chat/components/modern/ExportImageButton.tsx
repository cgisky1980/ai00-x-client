  ...
  return (
    <div className="export-content">
      <div className="export-content__header">
        <div className="export-content__logo-text">Ai00-X</div>
        <div className="export-content__title-group">
          <div className="export-content__title">Ai00-X</div>
      ...
      <div className="export-content__footer">
        ...
        <span className="export-content__footer-brand">Ai00-X</span>
        <span>•</span>
