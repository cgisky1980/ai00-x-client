...
export const CoworkExampleCards: React.FC<CoworkExampleCardsProps> = ({
  ...
  return (
    <div className="ai00-x-cowork-example-cards">
      <div className="ai00-x-cowork-example-cards__header">
        <div className="ai00-x-cowork-example-cards__title">{t('coreExamples.title')}</div>
        <div className="ai00-x-cowork-example-cards__header-actions">
          {onAddPlugin && (
