...
const VirtualFileRow = React.memo<VirtualFileRowProps>(({
  ...
  return (
    <div className="ai00-x-file-explorer__node">
      <FileTreeItem
        node={nodeForIcon}
        level={node.depth}
        indentPx={indentPx}
...
export const VirtualFileTree = forwardRef<VirtuosoHandle, VirtualFileTreeProps>(({
  ...
  if (flatNodes.length === 0) {
    return (
      <div className={`ai00-x-file-explorer__tree ai00-x-file-explorer__tree--empty ${className}`}>
        <div className="ai00-x-file-explorer__empty-message">
  ...
  return (
    <div 
      className={`ai00-x-file-explorer__tree ai00-x-file-explorer__tree--virtual ${className}`}
      style={{ height }}
      tabIndex={0}
    >
      <Virtuoso
