...
export const GenerativeWidgetPanel: React.FC<GenerativeWidgetPanelProps> = ({
  ...
  if (!widgetCode) {
    return (
      <div className="ai00-x-generative-widget-panel ai00-x-generative-widget-panel--empty">
        <div className="ai00-x-generative-widget-panel__empty-copy">
  ...
  return (
    <div className="ai00-x-generative-widget-panel">
