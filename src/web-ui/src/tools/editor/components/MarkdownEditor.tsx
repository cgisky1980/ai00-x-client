...
const MarkdownEditor: React.FC<MarkdownEditorProps> = ({
  ...
  if (loading) {
    return (
      <div className={`ai00-x-markdown-editor-loading ${className}`}>
  ...
  if (error) {
    return (
      <div className={`ai00-x-markdown-editor-error ${className}`}>
  ...
  if (shouldUseSourcePreviewFallback) {
    return (
      <div className={`ai00-x-markdown-editor ${className}`}>
        {notices.length > 0 && (
          <div className="ai00-x-markdown-editor__notice-bar">
            <AlertCircle className="ai00-x-markdown-editor__notice-icon" />
            <div className="ai00-x-markdown-editor__notice-copy">
              {notices.map(notice => (
        ...
        <div className="ai00-x-markdown-editor__mode-toolbar">
          <div className="ai00-x-markdown-editor__mode-toggle" role="tablist" aria-label={t('editor.markdownEditor.viewModeLabel')}>
            <Button
              type="button"
              size="small"
        ...
        <div className="ai00-x-markdown-editor__unsafe-body">
