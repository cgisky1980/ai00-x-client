...
const MENU_EVENT_ACTIONS: Array<{ eventName: string; action: EditMenuAction }> = [
  { eventName: 'ai00-x_menu_edit_undo', action: 'undo' },
  { eventName: 'ai00-x_menu_edit_redo', action: 'redo' },
  { eventName: 'ai00-x_menu_edit_cut', action: 'cut' },
  { eventName: 'ai00-x_menu_edit_copy', action: 'copy' },
  { eventName: 'ai00-x_menu_edit_paste', action: 'paste' },
  { eventName: 'ai00-x_menu_edit_select_all', action: 'selectAll' },
];
