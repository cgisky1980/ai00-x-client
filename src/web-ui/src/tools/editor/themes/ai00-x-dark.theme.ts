 ...
 * - Consistent with Ai00-X UI style
...
/**
 * Ai00-X Dark Theme Configuration
 ...
 */
export const Ai00XDarkTheme: editor.IStandaloneThemeData = {
  base: 'vs-dark',
  inherit: true,
...
export const Ai00XDarkThemeMetadata = {
  id: 'ai00-x-dark',
  label: 'Dark',
