...
export class AppManager implements IAppManager {
  ...
  private clearPersistedPanelState(): void {
    try {
      ...
      localStorage.removeItem('ai00-x-app-state');
      
      // Clear other potential panel state keys
      localStorage.removeItem('Ai00-X-left-panel-width');
      localStorage.removeItem('Ai00-X-left-panel-collapsed');
      localStorage.removeItem('Ai00-X-right-panel-collapsed');
