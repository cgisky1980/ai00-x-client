...
// ==================== File tree panel config ====================
export const FILE_TREE_PANEL_CONFIG = {
  COLLAPSED_WIDTH: 0,
  COMPACT_WIDTH: 180,
  COMPACT_THRESHOLD: 200,
  COMFORTABLE_MIN: 200,
  COMFORTABLE_DEFAULT: 240,
  EXPANDED_THRESHOLD: 320,
  MAX_WIDTH: 400,
  MIN_WIDTH: 180,
  DEFAULT_WIDTH: 240,
  SNAP_POINTS: [180, 240, 320, 400],
  SNAP_RANGE: 15,
...
export const STORAGE_KEYS = {
  LEFT_PANEL_WIDTH: 'ai00-x:leftPanelWidth',
  RIGHT_PANEL_WIDTH: 'ai00-x:rightPanelWidth',
  LEFT_PANEL_COLLAPSED: 'ai00-x:leftPanelCollapsed',
  RIGHT_PANEL_COLLAPSED: 'ai00-x:rightPanelCollapsed',
  LEFT_PANEL_LAST_WIDTH: 'ai00-x:leftPanelLastWidth',
  RIGHT_PANEL_LAST_WIDTH: 'ai00-x:rightPanelLastWidth',
  FILE_TREE_PANEL_WIDTH: 'ai00-x:fileTreePanelWidth',
  FILE_TREE_PANEL_COLLAPSED: 'ai00-x:fileTreePanelCollapsed',
} as const;
