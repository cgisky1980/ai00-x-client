...
export const RemoteConnectDisclaimerContent: React.FC<RemoteConnectDisclaimerContentProps> = ({
  ...
  return (
    <div className="ai00-x-remote-disclaimer">
      <div className="ai00-x-remote-disclaimer__meta">
        <Badge variant={agreed ? 'success' : 'warning'}>
          {t(agreed ? 'remoteConnect.disclaimerStatusAgreed' : 'remoteConnect.disclaimerStatusPending')}
        </Badge>
      </div>

      <p className="ai00-x-remote-disclaimer__text">{t('remoteConnect.disclaimerIntro')}</p>

      <ol className="ai00-x-remote-disclaimer__list">
      ...
      <div className="ai00-x-remote-disclaimer__actions">
        <button
          type="button"
          className="ai00-x-remote-disclaimer__btn ai00-x-remote-disclaimer__btn--secondary"
          onClick={onClose}
        >
        ...
        {canAgree && (
          <button
            type="button"
            className="ai00-x-remote-disclaimer__btn ai00-x-remote-disclaimer__btn--primary"
            onClick={onAgree}
          >
