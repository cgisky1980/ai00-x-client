...
const FileViewerNav: React.FC = () => {
  ...
  return (
    <div className="ai00-x-file-viewer-nav">
      <div className="ai00-x-file-viewer-nav__header">
        <span className="ai00-x-file-viewer-nav__icon" aria-hidden="true">
          <Folder size={15} />
        </span>
        <span className="ai00-x-file-viewer-nav__label">
          {t('nav.items.project')}
        </span>
        {currentWorkspace?.rootPath && (
          <span className="ai00-x-file-viewer-nav__actions">
