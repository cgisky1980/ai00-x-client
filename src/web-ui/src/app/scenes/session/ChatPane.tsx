...
import { PlanInputCard } from '../../../flow_chat/components/modern/PlanInputCard';
...
const ChatPaneInner: React.FC<ChatPaneProps> = ({
  ...
  showChatInput: _showChatInput = false,
}) => {
  ...
  return (
    <div
      className="ai00-x-chat-pane__content"
      data-fullscreen={isFullscreen}
    >
      <FlowChatContainer
        className="ai00-x-chat-pane__chat-container"
      ...
      />
      <div className="ai00-x-chat-pane__bottom-bar">
        <PlanInputCard />
        <ChatInput />
      </div>
    </div>
