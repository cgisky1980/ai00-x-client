pub(super) fn script() -> &'static str {
    ...
    const EVENT_NAME = "ai00_x_webdriver_result";
    const STORE_KEY = "__ai00-xWdElements";
    const LOG_KEY = "__ai00-xWdLogs";
    const consolePatchedKey = "__ai00-xWdConsolePatched";
    ...
    const patchDialogs = (targetWindow = window) => {
      const patchedKey = "__ai00-xWdDialogsPatched";
