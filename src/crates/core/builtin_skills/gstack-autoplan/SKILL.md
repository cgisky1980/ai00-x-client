...
keywords: plan, planning, design, architecture, decompose, specify
when_to_use: "Trigger when user wants to plan a feature, design architecture, decompose tasks, or create specifications."
