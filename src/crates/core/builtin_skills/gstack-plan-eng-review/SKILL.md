...
keywords: engineering, architecture, code, review, plan
when_to_use: "Trigger when user wants engineering plan review, architecture assessment, or code design evaluation."
