...
keywords: deploy, release, ship, publish, CI, CD, pipeline
when_to_use: "Trigger when user wants to deploy, release, publish, set up CI/CD pipelines, or ship code to production."
