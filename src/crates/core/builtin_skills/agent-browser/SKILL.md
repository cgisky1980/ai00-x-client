...
keywords: browser, web, automate, screenshot, navigate, scrape, crawl
when_to_use: "Trigger when user wants web automation, browser screenshots, page scraping, or browser-based testing."
