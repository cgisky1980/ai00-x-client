...
keywords: investigate, debug, diagnose, research, root cause
when_to_use: "Trigger when user wants to investigate bugs, diagnose issues, research root causes, or debug problems."
