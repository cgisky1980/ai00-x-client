...
impl HtmlLabels {
    ...
    pub fn en() -> Self {
        HtmlLabels {
            ...
            section_usage: "How You Use Ai00-X",
            ...
            md_additions: "AI00-X.md Additions",
...
fn render_suggestions(suggestions: &InsightsSuggestions, l: &HtmlLabels) -> String {
    ...
    if !suggestions.ai00x_md_additions.is_empty() {
