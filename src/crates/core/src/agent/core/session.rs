...
use crate::agent::execution::WorkflowPhase;
...
pub struct Session {
    ...
    /// Workflow phase state (persisted across turns)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub workflow_phase: Option<WorkflowPhaseState>,
...
pub struct SessionConfig {
    ...
    /// SSH config `host` for locating `~/.ai00-x/remote_ssh/{host}/.../sessions` when disconnected.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub remote_ssh_host: Option<String>,
    /// Model config ID used by this session (for token usage tracking)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub model_id: Option<String>,
    /// Sandbox branch name bound to this session.
    /// When set, the session's tool execution runs in the corresponding checkouts directory (.tasks/{branch-slash-to-dash}).
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        alias = "task_branch"
...
pub struct SessionSummary {
    ...
    pub sandbox_branch: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::service::session::types::SessionStatus>,
}
