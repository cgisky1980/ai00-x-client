...
fn tool_error(message: impl Into<String>) -> Ai00XError {
    Ai00XError::tool(message.into())
}
...
async fn get_mcp_server_manager() -> Ai00XResult<Arc<MCPServerManager>> {
