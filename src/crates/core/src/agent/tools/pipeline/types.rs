...
use crate::agent::core::{ToolCall, ToolExecutionState};
use crate::agent::events::SubagentParentInfo as EventSubagentParentInfo;
use crate::agent::tools::permission::PermissionLevel;
use crate::agent::tools::permission::PermissionPolicy;
...
pub struct ToolExecutionResult {
    ...
    pub result: crate::agent::core::ToolResult,
