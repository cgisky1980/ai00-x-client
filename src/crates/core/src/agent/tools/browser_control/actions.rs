...
impl<'a> BrowserActions<'a> {
    ...
    pub async fn navigate(&self, url: &str) -> Ai00XResult<Value> {
        let result = self
            .client
    ...
    pub async fn get_url(&self) -> Ai00XResult<String> {
    ...
    pub async fn get_title(&self) -> Ai00XResult<String> {
    ...
    pub async fn snapshot(&self) -> Ai00XResult<Value> {
        let script = r#"
        (function() {
    ...
    pub async fn get_text(&self, selector: &str) -> Ai00XResult<String> {
        let js = format!(
    ...
    pub async fn click(&self, selector: &str) -> Ai00XResult<Value> {
    ...
    pub async fn fill(&self, selector: &str, value: &str) -> Ai00XResult<Value> {
        let js = Self::resolve_element_js(selector);
        let focus_js = format!(
    ...
    pub async fn type_text(&self, text: &str) -> Ai00XResult<Value> {
        self.client
    ...
    pub async fn select(&self, selector: &str, option_text: &str) -> Ai00XResult<Value> {
        let js = format!(
            r#"(function(){{
    ...
    pub async fn press_key(&self, key: &str) -> Ai00XResult<Value> {
        self.client
            .send(
    ...
    /// Scroll the page.
    pub async fn scroll(&self, direction: &str, amount: Option<i64>) -> Ai00XResult<Value> {
    ...
    pub async fn screenshot(&self) -> Ai00XResult<Value> {
        let result = self
            .client
            .send(
    ...
    pub async fn evaluate(&self, expression: &str) -> Ai00XResult<Value> {
        self.client
            .send(
                "Runtime.evaluate",
                Some(json!({
    ...
    pub async fn close_page(&self) -> Ai00XResult<Value> {
