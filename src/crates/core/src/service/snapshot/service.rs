...
impl SnapshotService {
    ...
    pub async fn initialize(&mut self) -> SnapshotResult<()> {
        ...
        info!(
            "Snapshot service initialized: git_isolated={} ai00-x_dir={}",
            isolation_status,
    ...
    pub async fn get_system_stats(&self) -> SnapshotResult<SystemStats> {
        ...
        Ok(SystemStats {
            ...
            ai00x_dir: self.runtime_context.runtime_root.clone(),
        })
    }
    ...
    pub fn get_ai00x_dir(&self) -> &Path {
