...
//! in Ai00-X settings.  The desktop polls for updates via the Telegram Bot
    ...
    pub async fn set_bot_commands(&self) -> Result<()> {
        ...
        let commands = serde_json::json!({
            "commands": [
                ...
                { "command": "new_code_session", "description": "Create coding session" },
                { "command": "new_cowork_session", "description": "Create cowork session" },
